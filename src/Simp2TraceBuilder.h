...
#include <config.h>
#ifndef __SIMP2_TRACE_BUILDER_H__
#define __SIMP2_TRACE_BUILDER_H__
...
class Simp2TraceBuilder : public TSOPSOTraceBuilder{
public:
  Simp2TraceBuilder(const Configuration &conf = Configuration::default_conf);
