...
#include <config.h>
#ifndef __POP_TRACE_BUILDER_H__
#define __POP_TRACE_BUILDER_H__
...
class POPTraceBuilder : public TSOPSOTraceBuilder{
public:
  POPTraceBuilder(const Configuration &conf = Configuration::default_conf);
