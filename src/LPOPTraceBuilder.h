...
#include <config.h>
#ifndef __LPOP_TRACE_BUILDER_H__
#define __LPOP_TRACE_BUILDER_H__
...
class LPOPTraceBuilder : public TSOPSOTraceBuilder{
public:
  LPOPTraceBuilder(const Configuration &conf = Configuration::default_conf);
  ~LPOPTraceBuilder() override;
