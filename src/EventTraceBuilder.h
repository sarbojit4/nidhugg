...
protected:
   ...
   * (index) of that process after executing the WuT [0,event).
   */
  ...
  /* Traverses WuT to compute the set of threads that were sleeping
   * as the first event of WuT[i] started executing. Returns that
   * set.
   */
